return {
    ...
    config = function()
        ...
        --         if err then
        --             vim.notify("Error switching between source/header: " .. err.message, vim.log.levels.ERROR)
        --             return
        --         end
        --         if not result then
        ...
        --         if err then
        --             vim.notify("Error getting symbol info: " .. err.message, vim.log.levels.ERROR)
        --             return
        --         end
        --         if not result then
